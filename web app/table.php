...
//available table
$resultavb = mysql_query("SELECT COUNT(*) as available FROM  tables WHERE availability ='1'");
...
<script type="text/javascript">
    function GetTables($scope, $http) {
    // this is where the JSON from api.php is consumed
    $http.get('http://localhost:3000/api/table').
        success(function(data) {
            // here the data from the api is assigned to a variable named tables
            $scope.table = data;
        });
}
...
<div class="container">
	<div class="row">
        ...
        <div class="table-responsive" ng-controller="GetTables">
    ...
    <tr ng-repeat="table in tables"><td>{{table.tableID}}</td><td>{{ table.tableType }}</td><td>{{table.availability}}</td><td>{{table.availableCount}}</td></tr>
<?php 
